...
public class Parent_Bakery {
	...
	public double pMint_Oreo_Cake = 10.65;
	...
	{
		itemCost=Lemon_Drop_Bar + Vanilla_Cupcake + Chocolate_Cake + Mint_Oreo_Cake + Gooey_Brownies + Banana_Pudding + Cottage_Pudding + Boston_Cream_Pie + Cinnamon_Rolls + Ice_Cream_Cake;
